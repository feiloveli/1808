...
public class OSSClientUtil {
	 ...
	 */
	private String accessKeyId = "LTAISK3zc0pDWB4f";  //需要改
	private String accessKeySecret ="Sq7WdNorzCi3X7dwQ7P0IsDg6jhILv"; //需要改

	/**
	 * 填写创建的Bucket名称
	 */
	// 空间
	private String bucketName = "houduan";//需要改
	// 文件存储目录   对应Bucket的文件夹名称
	private String filedir = "houduan/";//需要改
